<?php 
$url = 'https://www.villaseniorito3.com/index.php';
...
<!--	Title
	=========================================================-->
<title>Home - Peoples Land Corporation</title>
</head>
<body>
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/04.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
           <h1> Peoples Land Corporation </h1>
        </div>
        <!--	Banner End  -->
                        ...
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
                                   ...
                                   $query = "SELECT * FROM property"; // Adjust table name if needed
        ...
        <div class="featured-thumb hover-zoomer mb-4">
            <div class="overlay-black overflow-hidden position-relative">
                <img src="admin/property/<?php echo htmlspecialchars($row['pimage']); ?> "alt="Property Image">
                <div class="featured bg-primary text-white">New</div>
                <div class="sale bg-secondary text-white text-capitalize">For <?php echo htmlspecialchars($row['status']); ?></div>
                <div class="price text-primary">
                    <b>₱ <?php echo number_format($row['price']); ?> </b>
                    <span class="text-white"><?php echo htmlspecialchars($row['size']); ?> Sqft</span>
                </div>
            </div>
            <div class="featured-thumb-data shadow-one">
                ...
                <div class="bg-gray quantity px-4 pt-4"></div>
