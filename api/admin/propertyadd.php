...
if(isset($_POST['add']))
{
	...
	$sql="insert into property (title,pcontent,size,price,location,city,state,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage)
	values('$title','$content','$asize','$price','$loc','$city','$state','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$fimage')";
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<?php echo $msg; ?>
										...
										<br>
											<input type="submit" value="Submit" class="btn btn-primary"name="add" style="margin-left:200px; width: 20%;">
